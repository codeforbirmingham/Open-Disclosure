...
# Purpose: This script reads the Organizations file
# generated by FindUniqueOrganizations.py and the Parties
# files downloaded from alabamavotes.gov, and combines the 
# information and makes requests to Google's Civic Information API 
# for things like contact info and photos.
